...
function splitCells(tableRow, count) {
	...
	if (
		cells.length > 0 &&
		!((_a2 = cells.at(-1)) == null ? void 0 : _a2.trim())
	) {
		cells.pop();
	}
	if (count) {
...
${currentText}`
	...
	table(src) {
		...
		const aligns = cap[2]
			...
			.split("|");
		const rows = ((_a2 = cap[3]) == null ? void 0 : _a2.trim())
		...
		if ((cap = this.rules.inline.url.exec(src))) {
			...
			if (cap[2] === "@") {
				...
				do {
					prevCapZero = cap[0];
					cap[0] =
						((_a2 = this.rules.inline._backpedal.exec(cap[0])) == null
							? void 0
							: _a2[0]) ?? "";
...
var _Lexer = class __Lexer {
	...
	blockTokens(src, tokens = [], lastParagraphClipped = false) {
		...
		while (src) {
			let token;
			if (
				(_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.block) ==
				null
					? void 0
	...
	inlineTokens(src, tokens = []) {
		...
		while (src) {
			...
			let token;
			if (
				(_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.inline) ==
				null
					? void 0
					: _b.some((extTokenizer) => {
							if ((token = extTokenizer.call({ lexer: this }, src, tokens))) {
...
var _Renderer = class {
	...
	code({ text, lang, escaped }) {
		var _a2;
		const langString =
			(_a2 = (lang || "").match(other.notSpaceStart)) == null ? void 0 : _a2[0];
...
`;
	...
	listitem(item) {
		...
		if (item.task) {
			...
			if (item.loose) {
				if (
					((_a2 = item.tokens[0]) == null ? void 0 : _a2.type) === "paragraph"
				) {
...
var _Parser = class __Parser {
	...
	parse(tokens, top = true) {
		...
		for (let i = 0; i < tokens.length; i++) {
			...
			if (
				(_b =
					(_a2 = this.options.extensions) == null ? void 0 : _a2.renderers) ==
				null
					? void 0
					: _b[anyToken.type]
			) {
		...
		for (const token of tokens) {
			...
			switch (token.type) {
				...
				default: {
					...
					if (
						(_b =
							(_a2 = this.defaults.extensions) == null
								? void 0
								: _a2.childTokens) == null
							? void 0
