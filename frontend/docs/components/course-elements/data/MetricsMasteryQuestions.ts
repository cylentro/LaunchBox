...
export const metricsMasteryQuestions = [
    // Chapter 1
    {
        ...
        questions: [
            {
                question: "What is the key difference between a 'data-driven' and a 'data-informed' approach?",
                options: [
                ...
                answer: "Data-driven treats data as the exclusive arbiter, while data-informed synthesizes data with qualitative insights and expertise."
            },
            {
                question: "What is a major limitation of a purely data-driven approach, especially for innovation?",
                options: [
                ...
                answer: "It is inherently backward-looking and can lead to local optimization, stifling breakthrough ideas."
            },
            {
                question: "In a data-informed culture, how is a conflict between quantitative data (e.g., A/B test results) and qualitative data (e.g., user interviews) viewed?",
                options: [
                ...
                answer: "As a signal that deeper understanding is required, prompting the creation of a testable hypothesis."
            },
            {
                question: "What does the term 'local optimization' refer to in the context of data pitfalls?",
                options: [
                ...
                answer: "Making small, measurable tweaks to minor variables while losing sight of the larger product vision."
            },
            {
                question: "According to the course, what is the primary strength of 'gut-feel' or 'product sense' in the early stages of a product?",
                options: [
                ...
                answer: "It is a form of subconscious pattern recognition built from deep user empathy and market knowledge, allowing for rapid decisions."
            }
        ],
    },
    // Chapter 2
        ...
        questions: [
            {
                ...
                answer: "To align the entire company on a single metric that represents the core value delivered to customers."
            },
            {
                question: "Why is revenue (like MRR) generally a poor choice for a North Star Metric?",
                options: [
                ...
                answer: "Because it is a lagging indicator of value captured, not a leading indicator of value being delivered."
            },
            {
                question: "In a Metric Tree, what is the relationship between Input Metrics and the North Star Metric (an Output Metric)?",
                options: [
                ...
                answer: "Input metrics are specific user behaviors that product teams can directly influence to affect the NSM."
            },
            {
                ...
                answer: "To monitor for unintended negative consequences of optimizing a primary metric."
            },
            {
                question: "When decomposing a North Star Metric, which of the following is NOT one of the four common dimensions of user engagement?",
                options: [
    ...
    // Chapter 3
    {
        ...
        questions: [
            {
                question: "Which of the following is NOT a characteristic of a SMART target?",
                options: [
                    "Specific",
                    "Measurable",
                    "Ambiguous",
            ...
            {
                question: "Which method for setting targets is considered a 'bottom-up' approach, based on the projected impact of planned initiatives?",
                options: [
            ...
            {
                question: "The 'triangulation' method for setting a robust target involves:",
                options: [
                ...
                answer: "Combining two or three different calculation methods (e.g., bottom-up, top-down, historical) to create a more realistic goal."
            },
            {
                question: "What is the main purpose of a 'Red-Yellow-Green' weekly review for tracking targets?",
                options: [
                ...
                answer: "To create a culture of continuous accountability and proactive problem-solving."
            },
            {
                question: "In the OKR framework, what is the relationship between an Objective and a Key Result?",
                options: [
                ...
                answer: "The Objective is the inspiring mission (the 'why'), and the Key Result is the measurable outcome (the 'what')."
            }
        ]
    },
    // Chapter 4
    {
        ...
        questions: [
            {
                question: "What is the primary use of the AARRR ('Pirate Metrics') framework?",
                options: [
                ...
                answer: "To diagnose the customer lifecycle funnel and identify the biggest 'leaks' or drop-off points."
            },
            {
                question: "In the AARRR framework, what does the 'Activation' stage represent?",
                options: [
                ...
                answer: "The 'Aha!' moment when a user experiences the product's core value for the first time."
            },
            {
                question: "According to the 'Hierarchy of Measurement,' how does the HEART framework relate to the AARRR framework?",
                options: [
                ...
                answer: "AARRR diagnoses *where* a problem is in the funnel, and HEART is used to understand *why* and guide a solution."
            },
            {
                question: "The Goals-Signals-Metrics (GSM) process is used to implement which framework?",
                options: [
                    "AARRR",
                    "HEART",
            ...
            {
                question: "Which HEART category would be most appropriate for measuring if users can complete a checkout process quickly and without errors?",
                options: [
                    "Happiness",
                    "Engagement",
                    "Adoption",
        ...
        questions: [
            {
                ...
                answer: "To quantitatively validate a specific hypothesis by comparing a change against a control."
            },
            {
                question: "In an experiment, what does 'statistical significance' tell you?",
                options: [
                ...
                answer: "The probability that the observed result was due to random chance, rather than the change you made."
            },
            {
                ...
                answer: "Connecting data points to a compelling narrative to make insights memorable and drive action."
            },
            {
                ...
                answer: "To gauge user interest and validate demand for a new feature before committing engineering resources."
            },
            {
                question: "Why is it crucial to tailor the communication of metric results to different audiences (e.g., executives vs. engineers)?",
                options: [
                ...
                answer: "Because different stakeholders care about different outcomes (e.g., ROI vs. technical debt) and speaking their language increases buy-in and drives action."
            }
        ]
    },
    // Chapter 6
    {
        ...
        questions: [
            {
                question: "In the 'ConnectSphere' B2C app launch case study, what was the most critical metric for validating early product-market fit?",
                options: [
                ...
                answer: "The flattening of the retention curve, even at a low percentage."
            },
            {
                question: "In the 'TaskFlow' B2B SaaS case study, how were the AARRR and HEART frameworks used together?",
                options: [
                ...
                answer: "AARRR was used to diagnose the funnel leak (low Activation), and HEART was used to guide the UX improvements for the solution."
            },
            {
                question: "What is the key principle highlighted in the 'StyleNow' e-commerce checkout funnel case study?",
                options: [
                ...
                answer: "Focus optimization efforts on the step with the highest percentage drop-off to achieve the maximum impact."
            },
            {
                question: "In the 'DataViz Pro' revival case study, what was the primary role of metrics in the strategic decision-making process?",
                options: [
                ...
                answer: "To forecast the potential impact and ROI of different future strategies."
            },
            {
                question: "The 'TaskFlow' B2B SaaS case study implemented a personalized onboarding flow. What was the primary metric used to measure its 'Task Success' according to the HEART framework?",
                options: [
                    "Net Promoter Score (NPS).",
